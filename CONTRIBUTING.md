...
Thank you for your interest in contributing to the Deep Agents CLI Skill for Claude.
...
Open an issue on [GitHub](https://github.com/Gitmaxd/deepagents-cli-claude-skill/issues) with:
